...
public class PromiseUsers {
    ...
    public static Promise<GeocoreUser, Exception, Void> user(String id) {
    ...
    public static Promise<List<GeocoreUser>, Exception, Void> users(GeocoreRequest query) {
    ...
    public static Promise<GeocoreUser, Exception, Void> save(GeocoreUser user) {
        final Deferred<GeocoreUser, Exception, Void> deferred = new DeferredObject<>();
        try {
    ...
    public static Promise<List<GeocoreUserEvent>, Exception, Void> queryEvents(String id) {
    ...
    public static Promise<GeocoreUser, Exception, Void> registerForPushNotification(String token) {
        final Deferred<GeocoreUser, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUser, Exception, Void> registerForPushNotification(String token, boolean enable) {
        final Deferred<GeocoreUser, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUser, Exception, Void> enablePushNotification() {
        final Deferred<GeocoreUser, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUser, Exception, Void> disablePushNotification() {
        final Deferred<GeocoreUser, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<List<GeocoreUser>, Exception, Void> getConnectedUsers() {
        final Deferred<List<GeocoreUser>, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<List<GeocoreUserRelationship>, Exception, Void> getUserRelationships() {
    ...
    public static Promise<List<GeocoreUser>, Exception, Void> getWaitingUsers() {
        final Deferred<List<GeocoreUser>, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<List<GeocoreUser>, Exception, Void> getPendingUsers() {
        final Deferred<List<GeocoreUser>, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUserRelationship, Exception, Void> getUserRelationship(String id) {
    ...
    public static Promise<GeocoreUserRelationship, Exception, Void> rejectUserRelationship(String id) {
        final Deferred<GeocoreUserRelationship, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUserRelationship, Exception, Void> createUserRelationship(String id) {
        final Deferred<GeocoreUserRelationship, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUserRelationship, Exception, Void> breakUserRelationship(String id) {
        final Deferred<GeocoreUserRelationship, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreUserEngagement, Exception, Void> engageUser(String id, GeocoreUserEngagementType type, String referral) {
    ...
    public static Promise<List<GeocoreFeed>, Exception, Void> getUserRelationshipLatestFeed(String id, int limit) {
    ...
    public static Promise<List<GeocoreFeed>, Exception, Void> getUserRelationshipLatestFeed(String id, int pageSize, int pageNumber) {
        final Deferred<List<GeocoreFeed>, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<List<GeocoreFeed>, Exception, Void> getUserRelationshipFeed(String id, Date toDate, int limit) {
        final Deferred<List<GeocoreFeed>, Exception, Void> deferred = new DeferredObject<>();
    ...
    public static Promise<GeocoreFeed, Exception, Void> postUserRelationshipFeed(String id, Map<String, Object> contentMap) {
